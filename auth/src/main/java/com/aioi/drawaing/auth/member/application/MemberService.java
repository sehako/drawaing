package com.aioi.drawaing.auth.member.application;

import static com.aioi.drawaing.auth.common.jwt.JwtTokenProvider.getRefreshTokenExpireTimeCookie;
import static com.aioi.drawaing.auth.oauth.infrastructure.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;

import com.aioi.drawaing.auth.common.code.ErrorCode;
import com.aioi.drawaing.auth.common.jwt.JwtTokenProvider;
import com.aioi.drawaing.auth.common.jwt.TokenInfo;
import com.aioi.drawaing.auth.common.response.ApiResponseEntity;
import com.aioi.drawaing.auth.common.util.CookieUtil;
import com.aioi.drawaing.auth.common.util.HeaderUtil;
import com.aioi.drawaing.auth.common.util.S3ImageUploader;
import com.aioi.drawaing.auth.common.util.SecurityUtil;
import com.aioi.drawaing.auth.member.application.request.MemberReqDto.Login;
import com.aioi.drawaing.auth.member.application.request.MemberReqDto.SignUp;
import com.aioi.drawaing.auth.member.application.response.MemberLoginResponse;
import com.aioi.drawaing.auth.member.domain.Member;
import com.aioi.drawaing.auth.member.infrastructure.repository.MemberRepository;
import com.aioi.drawaing.auth.member.presentation.request.MemberRequest;
import com.aioi.drawaing.auth.member.presentation.response.MemberResponse;
import com.aioi.drawaing.auth.oauth.domain.entity.ProviderType;
import com.aioi.drawaing.auth.oauth.domain.entity.RoleType;
