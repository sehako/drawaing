...
public class JwtTokenProvider {
    ...
    public com.aioi.drawaing.auth.common.jwt.TokenInfo generateToken(Authentication authentication) {
        ...
        return com.aioi.drawaing.auth.common.jwt.TokenInfo.builder()
    ...
    public com.aioi.drawaing.auth.common.jwt.TokenInfo generateToken(String id, String role) {
        long now = (new Date()).getTime();
        String accessToken = Jwts.builder()
                .subject(id)
