...
public enum NicknameCategory {
    ADJECTIVE(Arrays.asList(
            ...
            "활기찬", "중요한", "다정다감한", "재미있는", "가볍고유쾌한", "현명한", "배려있는", "이상적인", "창조적인", "웅장한", "기발한", "쾌활한", "탁월한",
            "사랑스러운", "소심한", "자유로운", "깊이있는", "다재다능한", "유능한", "친밀한", "흥미로운", "자기긍정적인", "능력있는", "전환가능한",
            "끈질긴", "해결사적인", "의식이높은", "용기있는", "집중력이뛰어난", "적극적인", "영양가득한", "균형있는", "불굴의의지를가진", "개방적인",
