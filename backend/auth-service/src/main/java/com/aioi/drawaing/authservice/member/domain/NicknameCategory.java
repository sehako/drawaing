...
public enum NicknameCategory {
    ADJECTIVE(Arrays.asList(
            ...
            "다양한", "화려한", "귀족적인", "대담무쌍한", "소박한", "강렬한", "눈부신", "매혹적인", "불가사의한", "재치있는", "풍부한", "무한한", "창의적인", "흔치않은",
            "호화로운", "영속적인", "복잡한", "경이로운", "신비로운", "은은한", "지속적인", "도전적인", "화사한", "자비로운", "천진난만한", "호쾌한", "다정한", "사려깊은",
            "매력있는", "온순한", "열린마음의", "후한", "찬란한", "심오한", "유쾌한", "순수한", "감동적인", "세련된", "매끄러운", "빛나는", "단아한", "화기애애한",
            "활기찬", "중요한", "다정다감한", "재미있는", "가볍고 유쾌한", "현명한", "배려있는", "이상적인", "창조적인", "웅장한", "기발한", "쾌활한", "탁월한",
            "포용력 있는", "소심한", "즐거운", "자유로운", "깊이 있는", "다재다능한", "유능한", "친밀한", "흥미로운", "자기긍정적인", "문제 해결 능력이 있는", "전환 가능한",
            "끈질긴", "해결사적인", "의식이 높은", "용기 있는", "결단력 있는", "집중력이 뛰어난", "적극적인", "영양 가득한", "균형 있는", "불굴의 의지를 가진", "개방적인",
            "접근이 쉬운", "조화로운", "세심한", "따뜻한", "지혜로운", "자비로운", "운명적인", "환상적인", "동화 같은", "명료한", "확신에 찬", "자기주장이 강한",
            "영감을 주는", "도전적인", "감성적인", "침착한", "편안한", "선명한", "낭만적인", "혁신적인", "실질적인", "조용한"
    )),
    NOUN(Arrays.asList(
            ...
            "낭타", "모래뱀", "삵", "비단뱀", "울타리비둘기", "삼엽충", "다이아몬드백", "배스킹상어", "황제펭귄", "줄무늬하이에나", "금강앵무", "딱정벌레", "뿔도마뱀",
            "비단원숭이", "개미핥기", "알바트로스", "큰부리새", "독일셰퍼드", "스네프스", "제비갈매기", "그리즐리곰", "아프리카코끼리", "잔나비거미", "블루마카우", "투캔",
            "털토끼", "핑크돌고래", "대왕오징어", "스펙클드물개", "붉은여우", "푸들", "불독", "세인트버나드", "스프링어스패니얼", "박쥐", "아이슬랜드말", "금화조", "서열몽키",
            "백조", "피그미하마", "그레이트피레니즈", "푸른발부비새", "황금개구리", "일본다람쥐", "영국흑새", "왕도마뱀", "리트리버", "홀스슈크랩", "호랑메기", "스팅레리",
