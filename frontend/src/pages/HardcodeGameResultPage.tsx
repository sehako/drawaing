...
const mockPlayers = [
  {
    memberId: "player1",
    nickname: "닭장주인",
    characterUrl: "/images/character1.png"
  },
  {
    memberId: "player2",
    nickname: "계란수집가",
    characterUrl: "/images/character2.png"
  },
  {
    memberId: "player3",
    nickname: "병아리",
    characterUrl: "/images/character3.png"
  },
  {
    memberId: "player4",
    nickname: "닭발러버",
    characterUrl: "/images/character4.png"
  }
];
...
const HardcodedGameResultPage: React.FC = () => {
  ...
  const rankSortedPlayers = mockPlayers.map((player, index) => ({
    player,
    result: mockResults[player.memberId],
