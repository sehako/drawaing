    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 mt-16">
          ...
          >
            <span className="text-3xl font-bold text-black font-['Press_Start_2P',_cursive] tracking-tight">로그인</span>
          </button>
          ...
          >
            <span className="text-3xl font-bold text-black font-['Press_Start_2P',_cursive] tracking-tight">게스트</span>
          </button>
        </div>
      ...
      {showLoginModal && (
        <Modal onClose={closeModal}>
          <div className="p-6">
            <h2 className="text-2xl font-bold mb-4 font-['Press_Start_2P',_cursive]">로그인</h2>
